...
/**
 * This part of the "real world" solution for RobotDrive. A PowerControlJaguar puts
 * out less power to allow us to compensate for one wheel spinning faster than
 * another. The PowerControlJaguar also has a built in ramp-up / ramp-down function
...
public class PowerControlJaguar extends Jaguar {
    ...
    * attached to. This functions like a regular jaguar with no power reduction.
    */
    ...
    * value is set using a range of -1.0 to 1.0, appropriately scaling the value
    * for the FPGA.
    *
   ...
   public void set(double speed) {
      ...
      //If the new voltage is fairly close to the current voltage, just change it.
      //Otherwise, the change should take up to 1/8 second.
      if (rampUp) {
